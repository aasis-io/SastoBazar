...
const Header = () => {
  return (
    <>
      ...
      {/* <header className="font-poppins flex items-center justify-evenly p-4 bg-orange-600">
        <div className="flex itmes-center">
        ...
        <div className="flex items-center ml-2">
          <div className="flex items-center">
            ...
            <span className="ml-1 text-white">Wishlist</span>
          </div>
          <div className="ml-4">
            <div className="relative">
              <FiShoppingCart className="h-6 w-6 text-white" />
              <span className="absolute top-0 right-0 inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-orange-600 transform translate-x-1/2 -translate-y-1/2 bg-white rounded-lg">
                0
              </span>
            </div>
          </div>
